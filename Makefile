...
./Output/sample7.17.tex: Samples/sample7.17.xml
	[ -d ./Output ] || mkdir ./Output
	mono Bin/FLaG.exe Samples/sample7.17.xml Output/sample7.17.tex
	[ -f ./Samples/sample7.17.tex.patch ] && patch -p1 -d ./Output < ./Samples/sample7.17.tex.patch
...
./Output/sample4.15.tex: Samples/sample4.15.xml
	[ -d ./Output ] || mkdir ./Output
	mono Bin/FLaG.exe Samples/sample4.15.xml Output/sample4.15.tex
	[ -f ./Samples/sample4.15.tex.patch ] && patch -p1 -d ./Output < ./Samples/sample4.15.tex.patch

./Output/sample4.16.tex: Samples/sample4.16.xml
	[ -d ./Output ] || mkdir ./Output
	mono Bin/FLaG.exe Samples/sample4.16.xml Output/sample4.16.tex
	[ -f ./Samples/sample4.16.tex.patch ] && patch -p1 -d ./Output < ./Samples/sample4.16.tex.patch
...
./Output/sample5.18.tex: Samples/sample5.18.xml
	[ -d ./Output ] || mkdir ./Output
	mono Bin/FLaG.exe Samples/sample5.18.xml Output/sample5.18.tex
	[ -f ./Samples/sample5.18.tex.patch ] && patch -p1 -d ./Output < ./Samples/sample5.18.tex.patch
...
./Output/sample1.16.tex: Samples/sample1.16.xml
	[ -d ./Output ] || mkdir ./Output
	mono Bin/FLaG.exe Samples/sample1.16.xml Output/sample1.16.tex
	[ -f ./Samples/sample1.16.tex.patch ] && patch -p1 -d ./Output < ./Samples/sample1.16.tex.patch

./Output/sample4.3.tex: Samples/sample4.3.xml
	[ -d ./Output ] || mkdir ./Output
	mono Bin/FLaG.exe Samples/sample4.3.xml Output/sample4.3.tex
	[ -f ./Samples/sample4.3.tex.patch ] && patch -p1 -d ./Output < ./Samples/sample4.3.tex.patch
...
tex: ./Output/sample5.5.tex ./Output/sample2.3.tex ./Output/sample4.2.tex ./Output/sample1.16.tex ./Output/sample1.8.tex ./Output/sample2.2.tex ./Output/sampledz6.4.tex ./Output/sampledz6.tex ./Output/sample3.6.tex ./Output/sample2.7.tex ./Output/sample6.3.tex ./Output/sample4.4.tex ./Output/sample5.4.tex ./Output/sample6.2.tex ./Output/sample4.1.tex ./Output/sample4.3.tex ./Output/sample7.17.tex ./Output/sample7.18.tex ./Output/sample7.3.tex ./Output/sample1.2.tex ./Output/sample1.7.tex ./Output/sample0.0.tex ./Output/sample1.4.tex ./Output/sample6.63.tex ./Output/sample5.16.tex ./Output/sample3.14.tex ./Output/sample5.17.tex ./Output/sample5.18.tex ./Output/sample4.16.tex ./Output/sample4.15.tex ./Output/sample4.14.tex ./Output/sample4.13.tex ./Output/sample1.13.tex ./Output/sample3.16.tex ./Output/sample2.14.tex
...
./Output/sample4.14.pdf: ./Output/sample4.14.tex
	[ -d ./Output ] || mkdir ./Output
	pdflatex --output-directory=./Output ./Output/sample4.14.tex
	pdflatex --output-directory=./Output ./Output/sample4.14.tex
	pdflatex --output-directory=./Output ./Output/sample4.14.tex

./Output/sample4.15.pdf: ./Output/sample4.15.tex
	[ -d ./Output ] || mkdir ./Output
	pdflatex --output-directory=./Output ./Output/sample4.15.tex
	pdflatex --output-directory=./Output ./Output/sample4.15.tex
	pdflatex --output-directory=./Output ./Output/sample4.15.tex

./Output/sample4.16.pdf: ./Output/sample4.16.tex
	[ -d ./Output ] || mkdir ./Output
	pdflatex --output-directory=./Output ./Output/sample4.16.tex
	pdflatex --output-directory=./Output ./Output/sample4.16.tex
	pdflatex --output-directory=./Output ./Output/sample4.16.tex
...
./Output/sample5.18.pdf: ./Output/sample5.18.tex
	[ -d ./Output ] || mkdir ./Output
	pdflatex --output-directory=./Output ./Output/sample5.18.tex
	pdflatex --output-directory=./Output ./Output/sample5.18.tex
	pdflatex --output-directory=./Output ./Output/sample5.18.tex
...
./Output/sample7.17.pdf: ./Output/sample7.17.tex
	[ -d ./Output ] || mkdir ./Output
	pdflatex --output-directory=./Output ./Output/sample7.17.tex
	pdflatex --output-directory=./Output ./Output/sample7.17.tex
	pdflatex --output-directory=./Output ./Output/sample7.17.tex
...
./Output/sample1.16.pdf: ./Output/sample1.16.tex
	[ -d ./Output ] || mkdir ./Output
	pdflatex --output-directory=./Output ./Output/sample1.16.tex
	pdflatex --output-directory=./Output ./Output/sample1.16.tex
	pdflatex --output-directory=./Output ./Output/sample1.16.tex
...
pdf: ./Output/sample5.5.pdf ./Output/sample2.1.pdf ./Output/sample2.1.pdf ./Output/sample2.3.pdf ./Output/sample4.2.pdf ./Output/sample1.16.pdf ./Output/sample1.8.pdf ./Output/sample2.2.pdf ./Output/sampledz6.4.pdf ./Output/sampledz6.pdf ./Output/sample3.6.pdf ./Output/sample2.7.pdf ./Output/sample6.3.pdf ./Output/sample4.4.pdf ./Output/sample5.4.pdf ./Output/sample6.2.pdf ./Output/sample4.1.pdf ./Output/sample4.3.pdf ./Output/sample7.17.pdf ./Output/sample7.18.pdf ./Output/sample7.3.pdf ./Output/sample1.2.pdf ./Output/sample1.7.pdf ./Output/sample0.0.pdf ./Output/sample1.4.pdf ./Output/sample6.63.pdf ./Output/sample5.16.pdf ./Output/sample3.14.pdf ./Output/sample5.17.pdf ./Output/sample5.18.pdf ./Output/sample4.16.pdf ./Output/sample4.15.pdf ./Output/sample4.14.pdf ./Output/sample4.13.pdf ./Output/sample1.13.pdf ./Output/sample3.16.pdf ./Output/sample2.14.pdf
